...
| :---: | :---: |
| [Click here](https://github.com/pkgforge-dev/dhewm3-AppImage/releases/latest) | [Click here](https://github.com/dhewm/dhewm3) |

</div>

## ⚠️ Place *.pk4 within `~/.local/share/dhewm3/base` ⚠️
